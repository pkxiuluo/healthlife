...
public class InviteFragment extends Fragment implements OnClickListener {
	private Button inviteByQQBtn;
	private Button inviteBySinaBtn;
	private Button inviteByWXBtn;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		inviteByQQBtn = (Button) root.findViewById(R.id.invite_qq_btn);
		inviteByQQBtn.setOnClickListener(this);
		inviteBySinaBtn = (Button) root.findViewById(R.id.invite_sina_btn);
		inviteBySinaBtn.setOnClickListener(this);
		inviteByWXBtn = (Button) root.findViewById(R.id.invite_wx_btn);
